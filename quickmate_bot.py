...
def main_buttons():
    keyboard = [
        ...
        [InlineKeyboardButton("IFSC Code Finder", callback_data="ifsc"),
         InlineKeyboardButton("Bank Full Form", callback_data="bank")]
    ]
