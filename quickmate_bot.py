...
banks = {
    ...
    "icici": ("Industrial Credit and Investment Corporation of India", "India"),
    "axis": ("Axis Bank", "India"),
    "kotak": ("Kotak Mahindra Bank", "India"),
    "pnb": ("Punjab National Bank", "India"),
    "bob": ("Bank of Baroda", "India"),
    "canara": ("Canara Bank", "India"),
    "union": ("Union Bank of India", "India"),
    "idbi": ("Industrial Development Bank of India", "India"),
    "rbl": ("RBL Bank", "India"),
    "yes": ("Yes Bank", "India"),
    "indusind": ("IndusInd Bank", "India"),
    "bandhan": ("Bandhan Bank", "India"),
    "boi": ("Bank of India", "India"),
    "uco": ("UCO Bank", "India"),
    "central": ("Central Bank of India", "India"),
    "iob": ("Indian Overseas Bank", "India"),
    "idfc": ("IDFC First Bank", "India"),
    "au": ("AU Small Finance Bank", "India"),
    "csb": ("CSB Bank", "India"),
    "south_indian": ("South Indian Bank", "India"),
    "karnataka": ("Karnataka Bank", "India"),
    "federal": ("Federal Bank", "India"),
    "karur_vysya": ("Karur Vysya Bank", "India"),
    "tmb": ("Tamilnad Mercantile Bank", "India"),
    "jk": ("Jammu & Kashmir Bank", "India"),
    "nainital": ("Nainital Bank", "India"),
    "saraswat": ("Saraswat Bank", "India"),
    "dcb": ("DCB Bank", "India"),
    "equitas": ("Equitas Small Finance Bank", "India"),
    "ujjivan": ("Ujjivan Small Finance Bank", "India"),
    "jana": ("Jana Small Finance Bank", "India"),
    "esaf": ("ESAF Small Finance Bank", "India"),
    "airtel": ("Airtel Payments Bank", "India"),
    "paytm": ("Paytm Payments Bank", "India"),
    "india_post": ("India Post Payments Bank", "India"),
    "finobank": ("Fino Payments Bank", "India"),
    "maharashtra": ("Bank of Maharashtra", "India"),
    "punjab_sind": ("Punjab & Sind Bank", "India"),
    "hsbc": ("Hongkong and Shanghai Banking Corporation", "United Kingdom"),
    "citi": ("Citibank", "United States"),
    "barclays": ("Barclays Bank", "United Kingdom"),
    "db": ("Deutsche Bank", "Germany"),
    "sc": ("Standard Chartered Bank", "United Kingdom"),
    "boa": ("Bank of America", "United States"),
    "jpm": ("JP Morgan Chase Bank", "United States"),
    "ubs": ("Union Bank of Switzerland", "Switzerland"),
    "credit_suisse": ("Credit Suisse", "Switzerland"),
    "bnpp": ("BNP Paribas", "France"),
    "socgen": ("Société Générale", "France"),
    "ing": ("ING Bank", "Netherlands"),
    "rbs": ("Royal Bank of Scotland", "United Kingdom"),
    "anz": ("Australia and New Zealand Banking Group", "Australia"),
    "westpac": ("Westpac Banking Corporation", "Australia"),
    "nab": ("National Australia Bank", "Australia"),
    "mizuho": ("Mizuho Bank", "Japan"),
    "sumitomo": ("Sumitomo Mitsui Banking Corporation", "Japan"),
    "boa_china": ("Bank of China", "China"),
    "icbc": ("Industrial and Commercial Bank of China", "China"),
    "ccb": ("China Construction Bank", "China"),
    "agri_china": ("Agricultural Bank of China", "China"),
    ...
    "intesa": ("Intesa Sanpaolo", "Italy"),
    "unicredit": ("UniCredit", "Italy"),
    "rabobank": ("Rabobank", "Netherlands"),
    "nordea": ("Nordea Bank", "Sweden"),
    "seb": ("Skandinaviska Enskilda Banken", "Sweden"),
    "kdb": ("Korea Development Bank", "South Korea"),
    "woori": ("Woori Bank", "South Korea"),
    "kb": ("KB Kookmin Bank", "South Korea"),
    "maybank": ("Malayan Banking Berhad", "Malaysia"),
    "cimb": ("CIMB Bank", "Malaysia"),
    "bank_mandiri": ("Bank Mandiri", "Indonesia"),
    "bri": ("Bank Rakyat Indonesia", "Indonesia"),
    "bni": ("Bank Negara Indonesia", "Indonesia"),
    "natwest": ("National Westminster Bank", "United Kingdom"),
    "rbl": ("RBL Bank", "India"),
    "uco": ("UCO Bank", "India"),
    "central": ("Central Bank of India", "India"),
    "idfc": ("IDFC First Bank", "India"),
    ...
    "bri": ("Bank Rakyat Indonesia", "Indonesia"),
    "bni": ("Bank Negara Indonesia", "Indonesia"),
    "idbi_cap": ("IDBI Capital Markets", "India"),
    "tjsb": ("TJSB Sahakari Bank", "India"),
    "abhyudaya": ("Abhyudaya Co-operative Bank", "India"),
    "bharat_coop": ("Bharat Co-operative Bank", "India"),
    "cosmos": ("Cosmos Co-operative Bank", "India"),
    "janakalyan": ("Janakalyan Sahakari Bank", "India"),
    "shamrao": ("Shamrao Vithal Co-operative Bank", "India"),
    "vasai": ("Vasai Vikas Sahakari Bank", "India"),
    "kalupur": ("Kalupur Commercial Co-operative Bank", "India"),
    "rajkot_nagrik": ("Rajkot Nagrik Sahakari Bank", "India"),
    "surat_people": ("Surat People's Co-operative Bank", "India"),
    "thane_bharat": ("Thane Bharat Sahakari Bank", "India"),
    "gp_parsik": ("GP Parsik Sahakari Bank", "India"),
    "nkgsb": ("NKGSB Co-operative Bank", "India"),
    "punjab_gramin": ("Punjab Gramin Bank", "India"),
    "kerala_gramin": ("Kerala Gramin Bank", "India"),
    "assam_gramin": ("Assam Gramin Vikash Bank", "India"),
    "odisha_gramya": ("Odisha Gramya Bank", "India"),
    "tripura_gramin": ("Tripura Gramin Bank", "India"),
    "manipur_rural": ("Manipur Rural Bank", "India"),
    "natixis": ("Natixis Bank", "France"),
    "ca_agricole": ("Crédit Agricole", "France"),
    "commerzbank": ("Commerzbank", "Germany"),
    "dz_bank": ("DZ Bank", "Germany"),
    "helaba": ("Landesbank Hessen-Thüringen", "Germany"),
    "abn_amro": ("ABN AMRO Bank", "Netherlands"),
    "ing_group": ("ING Group", "Netherlands"),
    "swedbank": ("Swedbank", "Sweden"),
    "handelsbanken": ("Svenska Handelsbanken", "Sweden"),
    "danske": ("Danske Bank", "Denmark"),
    "nordlb": ("Norddeutsche Landesbank", "Germany"),
    "kbc": ("KBC Bank", "Belgium"),
    "erste": ("Erste Group Bank", "Austria"),
    "raiffeisen": ("Raiffeisen Bank International", "Austria"),
    "bankia": ("Bankia", "Spain"),
    "sabadel": ("Banco Sabadell", "Spain"),
    "bper": ("BPER Banca", "Italy"),
    "mediobanca": ("Mediobanca", "Italy"),
    "bankinter": ("Bankinter", "Spain"),
    "ing_belgium": ("ING Belgium", "Belgium"),
    "cob": ("National Co-operative Bank", "India"),
    "utc": ("Urban Trust Co-operative Bank", "India"),
    "lakshmi_vilas": ("Lakshmi Vilas Bank", "India"),
    "dhanlaxmi": ("Dhanlaxmi Bank", "India"),
    "suryoday": ("Suryoday Small Finance Bank", "India"),
    "north_east_sfb": ("North East Small Finance Bank", "India"),
    "shivalik": ("Shivalik Small Finance Bank", "India"),
    "unity": ("Unity Small Finance Bank", "India"),
    "utkarsh": ("Utkarsh Small Finance Bank", "India"),
    "capri": ("Capri Global Capital Bank", "India"),
    "chaitanya": ("Chaitanya India Finance Bank", "India"),
    "muthoot": ("Muthoot Finance Bank", "India"),
    "manappuram": ("Manappuram Finance Bank", "India"),
    "edelweiss": ("Edelweiss Financial Services Bank", "India"),
    "lnt_fin": ("L&T Financial Services Bank", "India"),
    "tata_capital": ("Tata Capital Bank", "India"),
    "aditya_birla": ("Aditya Birla Finance Bank", "India"),
    "bajaj_fin": ("Bajaj Finserv Bank", "India"),
    "reliance_cap": ("Reliance Capital Bank", "India"),
    "iifl": ("IIFL Finance Bank", "India"),
    "motilal": ("Motilal Oswal Bank", "India"),
    "angelone": ("Angel One Bank", "India"),
    "la_caixa": ("CaixaBank", "Spain"),
    "unicaja": ("Unicaja Banco", "Spain"),
    "bankia_group": ("Bankia Group", "Spain"),
    "hypovereins": ("HypoVereinsbank", "Germany"),
    "sparkasse": ("Sparkasse Bank", "Germany"),
    "postbank": ("Postbank", "Germany"),
    "belfius": ("Belfius Bank", "Belgium"),
    "ing_lux": ("ING Luxembourg", "Luxembourg"),
    "banque_pop": ("Banque Populaire", "France"),
    "lcl": ("LCL Bank", "France"),
    "credit_mutuel": ("Crédit Mutuel", "France"),
    "n26": ("N26 Bank", "Germany"),
    "revolut": ("Revolut Bank", "United Kingdom"),
    "monzo": ("Monzo Bank", "United Kingdom"),
    "starling": ("Starling Bank", "United Kingdom"),
    "ally": ("Ally Bank", "United States"),
    "chime": ("Chime Bank", "United States"),
    "regions": ("Regions Bank", "United States"),
    "fifth_third": ("Fifth Third Bank", "United States"),
    "keybank": ("KeyBank", "United States"),
    "pnc": ("PNC Bank", "United States"),
    "huntington": ("Huntington National Bank", "United States"),
    "suntrust": ("SunTrust Bank", "United States"),
    "silicon_valley": ("Silicon Valley Bank", "United States"),
    "first_republic": ("First Republic Bank", "United States"),
    "city_union": ("City Union Bank", "India"),
    "kallappanna": ("Kallappanna Awade Ichalkaranji Janata Sahakari Bank", "India"),
    "rajgurunagar": ("Rajgurunagar Sahakari Bank", "India"),
    "sutex": ("Sutex Co-operative Bank", "India"),
    "zila_sahakari": ("Zila Sahakari Bank", "India"),
    "jalgaon_janta": ("Jalgaon Janata Sahakari Bank", "India"),
    "akola_urban": ("Akola Urban Co-operative Bank", "India"),
    "pune_people": ("Pune People's Co-operative Bank", "India"),
    "kolhapur_urban": ("Kolhapur Urban Bank", "India"),
    "sangli_urban": ("Sangli Urban Bank", "India"),
    "baramati_urban": ("Baramati Urban Bank", "India"),
    "solapur_urban": ("Solapur Urban Bank", "India"),
    "satara_urban": ("Satara Urban Bank", "India"),
    "belgaum_dcc": ("Belgaum District Central Co-operative Bank", "India"),
    "bidar_dcc": ("Bidar District Central Co-operative Bank", "India"),
    "dharwad_dcc": ("Dharwad District Central Co-operative Bank", "India"),
    "gulbarga_dcc": ("Gulbarga District Central Co-operative Bank", "India"),
    "udupi_dcc": ("Udupi District Central Co-operative Bank", "India"),
    "shimoga_dcc": ("Shimoga District Central Co-operative Bank", "India"),
    "hassan_dcc": ("Hassan District Central Co-operative Bank", "India"),
    "caixa_geral": ("Caixa Geral de Depósitos", "Portugal"),
    "millennium_bcp": ("Millennium BCP", "Portugal"),
    "bank_pekao": ("Bank Pekao", "Poland"),
    "pko_bp": ("PKO Bank Polski", "Poland"),
    "ing_poland": ("ING Bank Śląski", "Poland"),
    "otp_bank": ("OTP Bank", "Hungary"),
    "erste_cz": ("Česká spořitelna", "Czech Republic"),
    "csob": ("ČSOB Bank", "Czech Republic"),
    "komercni": ("Komerční banka", "Czech Republic"),
    "unicaja_group": ("Unicaja Group Bank", "Spain"),
    "sabadell_group": ("Banco Sabadell Group", "Spain"),
    "caixabank_pt": ("CaixaBank Portugal", "Portugal"),
    "bank_hapoalim": ("Bank Hapoalim", "Israel"),
    "leumi": ("Bank Leumi", "Israel"),
    "mizrahi": ("Mizrahi Tefahot Bank", "Israel"),
    "first_abu": ("First Abu Dhabi Bank", "United Arab Emirates"),
    "emirates_nbd": ("Emirates NBD", "United Arab Emirates"),
    "rakbank": ("RAKBANK", "United Arab Emirates"),
    "doha_bank": ("Doha Bank", "Qatar"),
    "qnb": ("Qatar National Bank", "Qatar"),
    "vasai_urban": ("Vasai Urban Bank", "India"),
    "palghar_dcc": ("Palghar District Central Co-operative Bank", "India"),
    "thane_dcc": ("Thane District Central Co-operative Bank", "India"),
    "raigad_dcc": ("Raigad District Central Co-operative Bank", "India"),
    "ratnagiri_dcc": ("Ratnagiri District Central Co-operative Bank", "India"),
    "sindhudurg_dcc": ("Sindhudurg District Central Co-operative Bank", "India"),
    "wardha_dcc": ("Wardha District Central Co-operative Bank", "India"),
    "nagpur_dcc": ("Nagpur District Central Co-operative Bank", "India"),
    "amravati_dcc": ("Amravati District Central Co-operative Bank", "India"),
    "yavatmal_dcc": ("Yavatmal District Central Co-operative Bank", "India"),
    "nanded_dcc": ("Nanded District Central Co-operative Bank", "India"),
    "latur_dcc": ("Latur District Central Co-operative Bank", "India"),
    "beed_dcc": ("Beed District Central Co-operative Bank", "India"),
    "osmanabad_dcc": ("Osmanabad District Central Co-operative Bank", "India"),
    "parbhani_dcc": ("Parbhani District Central Co-operative Bank", "India"),
    "hingoli_dcc": ("Hingoli District Central Co-operative Bank", "India"),
    "jalna_dcc": ("Jalna District Central Co-operative Bank", "India"),
    "buldhana_dcc": ("Buldhana District Central Co-operative Bank", "India"),
    "washim_dcc": ("Washim District Central Co-operative Bank", "India"),
    "gondia_dcc": ("Gondia District Central Co-operative Bank", "India"),
    "bank_muscat": ("Bank Muscat", "Oman"),
    "ahli_bank": ("Ahli Bank", "Oman"),
    "arab_bank": ("Arab Bank", "Jordan"),
    "housing_bank": ("Housing Bank for Trade and Finance", "Jordan"),
    "banque_misr": ("Banque Misr", "Egypt"),
    "national_egypt": ("National Bank of Egypt", "Egypt"),
    "attijariwafa": ("Attijariwafa Bank", "Morocco"),
    "bmce": ("BMCE Bank", "Morocco"),
    "ecobank": ("Ecobank", "Togo"),
    "standard_africa": ("Standard Bank Group", "South Africa"),
    "absa": ("ABSA Bank", "South Africa"),
    "nedbank": ("Nedbank", "South Africa"),
    "capitec": ("Capitec Bank", "South Africa"),
    "zenith": ("Zenith Bank", "Nigeria"),
    "gtbank": ("Guaranty Trust Bank", "Nigeria"),
    "access": ("Access Bank", "Nigeria"),
    "first_bank_ng": ("First Bank of Nigeria", "Nigeria"),
    "equity_ke": ("Equity Bank", "Kenya"),
    "kcb": ("Kenya Commercial Bank", "Kenya"),
    "crdb": ("CRDB Bank", "Tanzania"),
    "lloyds": ("Lloyds Bank", "United Kingdom"),
    "metro": ("Metro Bank", "United Kingdom"),
    "td": ("Toronto Dominion Bank", "Canada"),
    "rbc": ("Royal Bank of Canada", "Canada"),
    "scotiabank": ("Scotiabank", "Canada"),
    "bmo": ("Bank of Montreal", "Canada"),
    "wellsfargo": ("Wells Fargo", "United States"),
    "capitalone": ("Capital One", "United States"),
    "usbank": ("US Bank", "United States"),
    "goldman": ("Goldman Sachs", "United States"),
    "morgan": ("Morgan Stanley", "United States"),
}

# ---------------------------
# BANK / IFSC FUNCTION
# ---------------------------
def get_bank_info(text):
    text = text.strip().upper()

    # IFSC CHECK
    if len(text) == 11:
        try:
            r = requests.get(f"https://ifsc.razorpay.com/{text}")
            if r.status_code == 200:
                d = r.json()
                return (
                    f"✅ Bank Name : {d['BANK']}\n"
                    f"🏦 Branch Name : {d['BRANCH']}"
                )
            else:
                return "❌ Invalid IFSC Code"
        except:
            return "⚠️ IFSC Server Error"

    # BANK SHORT NAME CHECK
    key = text.lower()
    if key in bank_data:
        name, country = bank_data[key]
        return (
            f"✅ Bank Name : {name}\n"
            f"🌍 Country : {country}"
        )
...
TIN_CODE = {
    "jammu and kashmir": ("Jammu and Kashmir", "01", "JK"),
    "himachal pradesh": ("Himachal Pradesh", "02", "HP"),
    "punjab": ("Punjab", "03", "PB"),
    "chandigarh": ("Chandigarh", "04", "CH"),
    "uttarakhand": ("Uttarakhand", "05", "UK"),
    "haryana": ("Haryana", "06", "HR"),
    "delhi": ("Delhi", "07", "DL"),
    "rajasthan": ("Rajasthan", "08", "RJ"),
    "uttar pradesh": ("Uttar Pradesh", "09", "UP"),
    "bihar": ("Bihar", "10", "BR"),
    "sikkim": ("Sikkim", "11", "SK"),
    "arunachal pradesh": ("Arunachal Pradesh", "12", "AR"),
    "nagaland": ("Nagaland", "13", "NL"),
    "manipur": ("Manipur", "14", "MN"),
    "mizoram": ("Mizoram", "15", "MZ"),
    "tripura": ("Tripura", "16", "TR"),
    "meghalaya": ("Meghalaya", "17", "ML"),
    "assam": ("Assam", "18", "AS"),
    "west bengal": ("West Bengal", "19", "WB"),
    "jharkhand": ("Jharkhand", "20", "JH"),
    "odisha": ("Odisha", "21", "OD"),
    "chhattisgarh": ("Chhattisgarh", "22", "CG"),
    "madhya pradesh": ("Madhya Pradesh", "23", "MP"),
    "gujarat": ("Gujarat", "24", "GJ"),
    "dadra and nagar haveli and daman and diu": ("Dadra & Nagar Haveli and Daman & Diu", "26", "DN"),
    "maharashtra": ("Maharashtra", "27", "MH"),
    "andhra pradesh": ("Andhra Pradesh", "28", "AP"),
    "karnataka": ("Karnataka", "29", "KA"),
    "goa": ("Goa", "30", "GA"),
    "lakshadweep": ("Lakshadweep", "31", "LD"),
    "kerala": ("Kerala", "32", "KL"),
    "tamil nadu": ("Tamil Nadu", "33", "TN"),
    "puducherry": ("Puducherry", "34", "PY"),
    "andaman and nicobar islands": ("Andaman & Nicobar Islands", "35", "AN"),
    "telangana": ("Telangana", "36", "TS"),
    "andhra pradesh new": ("Andhra Pradesh (New)", "37", "AD"),
    "ladakh": ("Ladakh", "38", "LA")
}
...
UQC = {
    ...
    "cartons": ("Cartons", "CTN"),
    "cases": ("Cases", "CAS"),
    "cubic meter": ("Cubic Meter", "CBM"),
    "cubic centimeter": ("Cubic Centimeter", "CCM"),
    "centimeter": ("Centimeter", "CMS"),
    "dozen": ("Dozen", "DOZ"),
    "drum": ("Drum", "DRM"),
    "grams": ("Grams", "GMS"),
    "gross": ("Gross", "GRS"),
    "kilogram": ("Kilogram", "KGS"),
    "kiloliter": ("Kiloliter", "KLR"),
    "kilometre": ("Kilometre", "KME"),
    "litre": ("Litre", "LTR"),
    "millilitre": ("Millilitre", "MLT"),
    "millimeter": ("Millimeter", "MTR"),
    "meter": ("Meter", "MTR"),
    "metric ton": ("Metric Ton", "MTS"),
    "numbers": ("Numbers", "NOS"),
    "pack": ("Pack", "PAC"),
    "pairs": ("Pairs", "PRS"),
    "pieces": ("Pieces", "PCS"),
    ...
    "sets": ("Sets", "SET"),
    "sheets": ("Sheets", "SHT"),
    "square feet": ("Square Feet", "SQF"),
    "square meter": ("Square Meter", "SQM"),
    "square yard": ("Square Yard", "SQY"),
    "tubes": ("Tubes", "TUB"),
    "tons": ("Tons", "TON"),
    "truckload": ("Truckload", "TRK"),
    "unit": ("Unit", "UNT"),
    "yard": ("Yard", "YDS")
}
...
def main_buttons():
    keyboard = [
        ...
        [InlineKeyboardButton("TIN Code", callback_data="tin_code"),
         InlineKeyboardButton("UQC", callback_data="uqc")],
        [InlineKeyboardButton("IFSC Code Finder", callback_data="ifsc_code_finder"),
         InlineKeyboardButton("Bank Full Form", callback_data="bank_full_form")]
    ]
...
async def handle_pin_code(update: Update, context: ContextTypes.DEFAULT_TYPE, waiting_msg=None):
    ...
    if not pin_code.isdigit() or len(pin_code) != 6:
        await waiting_msg.edit_text(
            "⚠ India Post server busy hai.\n⏳ Thodi der baad try kare."
        )
        return
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "pin_code":
        ...
        user_state[user_id]["mode"] = "TIN_CODE_WAIT"
        await query.message.reply_text("🏛 Enter State Name or TIN Code:")

    elif data == "uqc":
        user_state[user_id]["mode"] = "UQC_WAIT"
        await query.message.reply_text("📦 Enter Item Name or UQC Code:")

    elif data == "ifsc_code_finder":
        user_state[user_id]["mode"] = "IFSC_CODE_FINDER_WAIT"
        await query.message.reply_text("⚡ Please Enter IFSC Code:")

    elif data == "bank_full_form":
        user_state[user_id]["mode"] = "BANK_FULL_FORM_WAIT"
        await query.message.reply_text("🏦 Please Enter Bank Short Name:")
...
# TIN CODE
# -------------------------
    elif mode == "TIN_CODE_WAIT":
        if not text:
            await waiting_msg.edit_text("❌ Enter valid State Name or TIN Code.")
            return

        key = text.lower().strip()

        found = False
        for state, data in TIN_CODE.items():
            name, tin, code = data

            if key == state or key == tin:
                resp = (
                    f"🛖 State Name: {name} ({code})\n"
                    f"🧾 TIN Code: {tin}"
                )
                await waiting_msg.edit_text(resp)
                found = True
        ...
        if not found:
            await waiting_msg.edit_text("❌ Invalid TIN Code. Please try again.")
...
# -------------------------
        ...
        if not text:
            await waiting_msg.edit_text("❌ Enter valid Item Name or UQC Code.")
            return

        key = text.lower().strip()

        found = False
        for item, data in UQC.items():
            name, code = data

            if key == item or key == code.lower():
                resp = (
                    f"📦 Item Name: {name}\n"
                    f"🧾 UQC Code: {code}"
                )
        ...
        if not found:
            await waiting_msg.edit_text("❌ Invalid UQC Code. Please try again.")

# -------------------------
# IFSC CODE
# -------------------------
    elif mode == "IFSC_CODE_FINDER_WAIT":
        if not text:
            await waiting_msg.edit_text("❌ Enter valid IFSC code.")
            return

        try:
            data = await asyncio.to_thread(
                lambda: requests.get(f"https://ifsc.razorpay.com/{text}").json()
            )
            ...
            if "BANK" in data:
                ...
                await waiting_msg.edit_text("❌ Invalid IFSC Code. Please try again.")

        except:
            await waiting_msg.edit_text("⚠️ Error fetching IFSC details.")


# -------------------------
# BANK FULL FORM
# -------------------------
    elif mode == "BANK_FULL_FORM_WAIT":
        if not text:
            await waiting_msg.edit_text("❌ Enter bank short name.")
            return
        ...
        if key in bank_data:
            ...
            resp = (
                f"🧨 Bank Name: {name}\n"
                f"🌍 And The Country Name: {country}"
            )
            await waiting_msg.edit_text(resp)
        else:
            await waiting_msg.edit_text("❌ Bank not found. Please try again.")
