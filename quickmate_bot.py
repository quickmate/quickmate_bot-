...
# Config
# -------------------------
BOT_TOKEN = "8539997474:AAF4TRVaxwHfnDd9WlHTLMA_hQEEJpdDHFg"
...
bank_data = {
    ...
    "allahabad": ("Allahabad Bank", "India"),
    "andhra": ("Andhra Bank", "India"),
    "corporation": ("Corporation Bank", "India"),
    "dena": ("Dena Bank", "India"),
    "oriental": ("Oriental Bank of Commerce", "India"),
    "syndicate": ("Syndicate Bank", "India"),
    "vijaya": ("Vijaya Bank", "India"),
    "united_bank": ("United Bank of India", "India"),
    "bharatiya_mahila": ("Bharatiya Mahila Bank", "India"),
    "idbi_mutual": ("IDBI Mutual Fund Bank", "India"),
    "apna_sahakari": ("Apna Sahakari Bank", "India"),
    "bombay_mercantile": ("Bombay Mercantile Co-operative Bank", "India"),
    "kalyan_janta": ("Kalyan Janata Sahakari Bank", "India"),
    "mahesh": ("Mahesh Sahakari Bank", "India"),
    "pragati_sahakari": ("Pragati Sahakari Bank", "India"),
    "rajkot_district": ("Rajkot District Co-operative Bank", "India"),
    "kolhapur_dcc": ("Kolhapur District Central Co-operative Bank", "India"),
    "satara_dcc": ("Satara District Central Co-operative Bank", "India"),
    "sangli_dcc": ("Sangli District Central Co-operative Bank", "India"),
    "ahmednagar_dcc": ("Ahmednagar District Central Co-operative Bank", "India"),
    "aurangabad_dcc": ("Aurangabad District Central Co-operative Bank", "India"),
    "nasik_dcc": ("Nashik District Central Co-operative Bank", "India"),
    "solapur_dcc": ("Solapur District Central Co-operative Bank", "India"),
    "jalgaon_dcc": ("Jalgaon District Central Co-operative Bank", "India"),
    "dhule_dcc": ("Dhule District Central Co-operative Bank", "India"),
    "kolkata_coop": ("Kolkata Cooperative Bank", "India"),
    "uttar_banga": ("Uttar Banga Kshetriya Gramin Bank", "India"),
    "bangiya_gramin": ("Bangiya Gramin Vikash Bank", "India"),
    "paschim_banga": ("Paschim Banga Gramin Bank", "India"),
    "odisha_state": ("Odisha State Cooperative Bank", "India"),
    "apgb": ("Andhra Pradesh Grameena Bank", "India"),
    "telangana_grameena": ("Telangana Grameena Bank", "India"),
    "karnataka_vikas": ("Karnataka Vikas Grameena Bank", "India"),
    "uttarakhand_gramin": ("Uttarakhand Gramin Bank", "India"),
    "baroda_up": ("Baroda Uttar Pradesh Gramin Bank", "India"),
    "baroda_rajasthan": ("Baroda Rajasthan Kshetriya Gramin Bank", "India"),
    "jharkhand_gramin": ("Jharkhand Rajya Gramin Bank", "India"),
    "bihar_gramin": ("Dakshin Bihar Gramin Bank", "India"),
    "north_bihar": ("Uttar Bihar Gramin Bank", "India"),
    "tripura_state": ("Tripura State Cooperative Bank", "India"),
    ...
    "citizens_us": ("Citizens Bank", "United States"),
    "truist": ("Truist Bank", "United States"),
    "m&t": ("M&T Bank", "United States"),
    "synchrony": ("Synchrony Bank", "United States"),
    "discover": ("Discover Bank", "United States"),
    "amex": ("American Express Bank", "United States"),
    "svb_private": ("SVB Private Bank", "United States"),
    "first_citizens": ("First Citizens Bank", "United States"),
    "u_s_bancorp": ("U.S. Bancorp", "United States"),
    "state_street": ("State Street Bank", "United States"),

    # 🇬🇧 United Kingdom
    "hsbc_uk": ("HSBC UK Bank", "United Kingdom"),
    "co_op": ("The Co-operative Bank", "United Kingdom"),
    "virgin_money": ("Virgin Money", "United Kingdom"),
    "tsb": ("TSB Bank", "United Kingdom"),
    "nationwide": ("Nationwide Building Society", "United Kingdom"),
    "aldermore": ("Aldermore Bank", "United Kingdom"),
    "shawbrook": ("Shawbrook Bank", "United Kingdom"),
    "metro_uk": ("Metro Bank UK", "United Kingdom"),
    "clydesdale": ("Clydesdale Bank", "United Kingdom"),
    "yorkshire": ("Yorkshire Bank", "United Kingdom"),

    # 🇩🇪 Germany
    "ing_de": ("ING Germany", "Germany"),
    "dekabank": ("DekaBank", "Germany"),
    "lbbw": ("Landesbank Baden-Württemberg", "Germany"),
    "bayern_lb": ("BayernLB", "Germany"),
    "nrw_bank": ("NRW Bank", "Germany"),
    "hamburg_com": ("Hamburg Commercial Bank", "Germany"),
    "ikb": ("IKB Deutsche Industriebank", "Germany"),
    "psd": ("PSD Bank", "Germany"),
    "berliner": ("Berliner Sparkasse", "Germany"),
    "vr_bank": ("VR Bank Germany", "Germany"),

    # 🇫🇷 France
    "bpce": ("BPCE Group", "France"),
    "credit_du_nord": ("Crédit du Nord", "France"),
    "banque_postale": ("La Banque Postale", "France"),
    "hsbc_fr": ("HSBC France", "France"),
    "odelo": ("Oney Bank", "France"),
    "cacib": ("Crédit Agricole CIB", "France"),
    "natixis_inv": ("Natixis Investment Bank", "France"),
    "socgen_private": ("Société Générale Private Banking", "France"),
    "cmutuel_cic": ("Crédit Mutuel CIC", "France"),
    "banque_wormser": ("Banque Wormser Frères", "France"),

    # 🇯🇵 Japan
    "resona": ("Resona Bank", "Japan"),
    "shinsei": ("SBI Shinsei Bank", "Japan"),
    "aozora": ("Aozora Bank", "Japan"),
    "fukuoka": ("Fukuoka Financial Group", "Japan"),
    "chiba": ("Chiba Bank", "Japan"),
    "hiroshima": ("Hiroshima Bank", "Japan"),
    "shizuoka": ("Shizuoka Bank", "Japan"),
    "hokkaido": ("Hokkaido Bank", "Japan"),
    "yokohama": ("Bank of Yokohama", "Japan"),
    "japan_post": ("Japan Post Bank", "Japan"),

    # 🇨🇳 China
    "cmb": ("China Merchants Bank", "China"),
    "citic": ("China CITIC Bank", "China"),
    "psbc": ("Postal Savings Bank of China", "China"),
    "spd": ("Shanghai Pudong Development Bank", "China"),
    "ceb": ("China Everbright Bank", "China"),
    "cmbc": ("China Minsheng Bank", "China"),
    "pingan": ("Ping An Bank", "China"),
    "bank_comm": ("Bank of Communications", "China"),
    "bohai": ("Bohai Bank", "China"),
    "shengjing": ("Shengjing Bank", "China"),

    # 🇦🇺 Australia
    "bendigo": ("Bendigo and Adelaide Bank", "Australia"),
    "macquarie": ("Macquarie Bank", "Australia"),
    "suncorp": ("Suncorp Bank", "Australia"),
    "amp": ("AMP Bank", "Australia"),
    "bankwest": ("Bankwest", "Australia"),
    "me_bank": ("ME Bank", "Australia"),
    "heritage": ("Heritage Bank", "Australia"),
    "teachers_mutual": ("Teachers Mutual Bank", "Australia"),
    "greater": ("Greater Bank", "Australia"),
    "newcastle": ("Newcastle Permanent", "Australia"),

    # 🇪🇺 Europe (Mixed)
    "ing_ro": ("ING Romania", "Romania"),
    "banca_intesa_rs": ("Banca Intesa Serbia", "Serbia"),
    "pkobp": ("PKO BP", "Poland"),
    "mbank": ("mBank", "Poland"),
    "unicaja_es": ("Unicaja Banco Spain", "Spain"),
    "bankia_es": ("Bankia Spain", "Spain"),
    "caixabank_es": ("CaixaBank Spain", "Spain"),
    "novobanco": ("Novo Banco", "Portugal"),
    "bcp_pt": ("Banco Comercial Português", "Portugal"),
    "alpha_gr": ("Alpha Bank", "Greece"),

    # 🇨🇦 Canada
    "desjardins": ("Desjardins Group", "Canada"),
    "atb": ("ATB Financial", "Canada"),
    "laurentian": ("Laurentian Bank", "Canada"),
    "canadian_west": ("Canadian Western Bank", "Canada"),
    "eq_bank": ("EQ Bank", "Canada"),

    # 🌍 Others
    "masraf": ("Mashreq Bank", "United Arab Emirates"),
    "fab_misr": ("FAB Misr", "Egypt"),
    "bank_negara": ("Bank Negara Indonesia", "Indonesia"),
    "maybank_my": ("Maybank Malaysia", "Malaysia"),
    "casa_do_brasil": ("Banco do Brasil", "Brazil"),
    "itau": ("Itaú Unibanco", "Brazil"),
    "bradesco": ("Bradesco Bank", "Brazil"),
    "santander_br": ("Santander Brazil", "Brazil"),
    "banco_chile": ("Banco de Chile", "Chile"),
    "banco_estado": ("BancoEstado", "Chile"),
