...
bank_data = {
    ...
    "nsdl": ("NSDL Payments Bank", "India"),
    "finobank": ("Fino Payments Bank", "India"),
    "apgb": ("Andhra Pradesh Grameena Bank", "India"),
    "baroda_up": ("Baroda UP Bank", "India"),
    "baroda_guj": ("Baroda Gujarat Grameen Bank", "India"),
    "punjab_sind": ("Punjab & Sind Bank", "India"),
    "maharashtra": ("Bank of Maharashtra", "India"),
    "odisha": ("Odisha Gramya Bank", "India"),
    "kerala": ("Kerala Gramin Bank", "India"),
    "assam": ("Assam Gramin Vikash Bank", "India"),
    "tripura": ("Tripura Gramin Bank", "India"),
    "manipur": ("Manipur Rural Bank", "India"),
    "nagaland": ("Nagaland Rural Bank", "India"),
    "meghalaya": ("Meghalaya Rural Bank", "India"),
    ...
    "icbc_eu": ("ICBC Europe", "Europe"),
    "natwest": ("National Westminster Bank", "UK"),
    "lloyds": ("Lloyds Bank", "UK"),
    "metro": ("Metro Bank", "UK"),
    "td": ("Toronto Dominion Bank", "Canada"),
    "rbc": ("Royal Bank of Canada", "Canada"),
    "scotiabank": ("Scotiabank", "Canada"),
    "bmo": ("Bank of Montreal", "Canada"),
    "wellsfargo": ("Wells Fargo", "USA"),
    "capitalone": ("Capital One", "USA"),
    "usbank": ("US Bank", "USA"),
    "goldman": ("Goldman Sachs", "USA"),
    "morgan": ("Morgan Stanley", "USA"),
}
...
def main_buttons():
    keyboard = [
        ...
        [InlineKeyboardButton("GK Quizzes", callback_data="gk_quizzes"),
        ...
        [InlineKeyboardButton("Facts", callback_data="facts"),
         InlineKeyboardButton("Weather Info", callback_data="weather_info")],
...
# -------------------------
        ...
        if not text:
            await waiting_msg.edit_text("❌ Enter State Name or TIN Code.")
            return
        ...
        for state, data in TIN_CODE.items():
            ...
            await waiting_msg.edit_text("⚠️ Error fetching TIN code details.")
...
# -------------------------
        ...
        if not text:
            await waiting_msg.edit_text("❌ Enter Item Name or UQC Code.")
            return
        ...
        for item, data in UQC.items():
            ...
            await waiting_msg.edit_text("⚠️ Error fetching UQC code details.")
