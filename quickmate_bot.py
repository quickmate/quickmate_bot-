...
# -------------------------
        ...
        if not text:
            await update.message.reply_text("❌ Enter State Name or TIN Code.")
            return
        ...
        await update.message.reply_text("❌ State or TIN Code not found.")
...
# -------------------------
        ...
        if not text:
            await update.message.reply_text("❌ Enter Item Name or UQC Code.")
            return
        ...
        await update.message.reply_text("❌ UQC Code or Item not found.")
