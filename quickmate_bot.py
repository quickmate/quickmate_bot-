...
# -------------------------
        ...
        waiting_msg = user_state[user_id]["waiting_msg"]
        ...
        await waiting_msg.edit_text("❌ State or TIN Code not found.")
...
# -------------------------
        ...
        await waiting_msg.edit_text("❌ UQC Code or Item not found.")
