...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "pin_code":
        ...
        user_state[user_id]["mode"] = "IFSC"
        await update.message.reply_text("⚡ Please Enter IFSC Code:")

    elif data == "bank_full_form":
        user_state[user_id]["mode"] = "BANK"
        await update.message.reply_text("🏦 Please Enter Bank Short Name:")
